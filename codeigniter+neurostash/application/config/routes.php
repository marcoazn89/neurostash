...
$route['read/(:any)'] = "crud_controller/read/$1";
$route['read/(:any)/(:num)'] = "crud_controller/read/$1/$2";
$route['create/(:any)'] = "crud_controller/create/$1";
$route['update/(:any)'] = "crud_controller/update/$1";
$route['update/(:any)/(:num)'] = "crud_controller/update/$1/$2";
$route['delete/(:any)'] = "crud_controller/delete/$1";
